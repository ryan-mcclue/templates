...
INTERNAL f64 f64_ln(f64 x) { return log(x); }
  ...
  INTERNAL f32 f32_powi(f32 x, i32 y) { return __builtin_powif(x, y); }
...
INTERNAL Vec2F32 vec2_f32_arm(f32 angle) { return vec2_f32(cos_f32(angle), f32_sin(angle)); }
INTERNAL Vec2F32 vec2_f32_perp(Vec2F32 a) { return vec2_f32(-a.y, a.x); }
INTERNAL f32 vec2_f32_angle(Vec2F32 a) { return atan2_f32(a.y, a.x); }
...
INTERNAL f32 vec2_f32_length(Vec2F32 v) { return sqrt_f32(vec2_f32_lengthsq(v)); }
...
INTERNAL f32 vec3_f32_length(Vec3F32 v) { return sqrt_f32(vec3_f32_lengthsq(v)); }
...
INTERNAL f32 vec4_f32_length(Vec4F32 v) { return sqrt_f32(vec4_f32_lengthsq(v)); }
...
INTERNAL Vec2I32 vec2_i32(i32 x, i32 y) { return {x, y}; }
INTERNAL Vec2I64 vec2_i64(i64 x, i64 y) { return {x, y}; }
