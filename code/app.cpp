...
// render_system = ENTITY_COMPONENT_FLAG_SPRITE | ENTITY_COMPONENT_FLAG_TRANSFORM;
              // SDL_SetRenderDrawColor(renderer, 255, 255, 255, 255); after drawing sprite

// sorting should happen a layer above storage?

// asset creating a mapping between code reference and file reference
// don't use pointers for assets
// consider types of assets, e.g. arrayed (grass[]), structured (hero_face, hero_body)
// currently: render(entity.sprite.texture)
...
*/
  ...
  SDL_FRect dst = { 50.0f, 50.0f, 128.0f, 128.0f };
  SDL_RenderCopyF(renderer->renderer, texture, NULL, &dst);
#endif
